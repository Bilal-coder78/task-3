    ...
    return (
        <div className='container my-5'>
            ...
            <div className="row align-items-center justify-content-center">
                <div className="col-lg d-flex flex-column gap-4 my-4">
                    <div className="d-flex justify-content-center flex-column flex-lg-row align-items-center gap-3">
                        ...
                        <div className="p-3 rounded-5 first"><BsDisplay className='fs-4 second' /></div>
                    </div>
                    <div className="d-flex justify-content-center flex-column flex-lg-row align-items-center gap-3">
                        <div className="text-lg-end text-center">
                        ...
                        <div className="p-3 rounded-5 first"><BsFeather className='fs-4 second' /></div>
                    </div>
                    <div className="d-flex justify-content-center flex-column flex-lg-row align-items-center gap-3">
                        <div className="text-lg-end text-center">
                        ...
                        <div className="p-3 rounded-5 first"><FiEye className='fs-4 second' /></div>
                    </div>
                </div>
                ...
                <div className="col-lg">
                    <div className="col-md d-flex align-items-center justify-content-center flex-column gap-4 my-4">
                        <div className="d-flex justify-content-center flex-column flex-lg-row align-items-center gap-3">
                            <div className="p-3 rounded-5 first"><GoCodeSquare className='fs-4 second' /></div>
                        ...
                        <div className="d-flex justify-content-center flex-column flex-lg-row align-items-center gap-3">
                            <div className="p-3 rounded-5 first"><LuSmartphone className='fs-4 second' /></div>
                            <div className="text-lg-start text-center">
                        ...
                        <div className="d-flex justify-content-center flex-column flex-lg-row align-items-center gap-3">
                            <div className="p-3 rounded-5 first"><BsBrowserChrome className='fs-4 second' /></div>
                            <div className="text-lg-start text-center">
