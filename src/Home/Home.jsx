    ...
    <>
      <div style={{ backgroundColor: "#f6f9ff" }}>
        <div id='home' className='container w-100'>
          <div class="row">
            <div class="left-home col-12 col-lg-6 d-flex align-items-center justify-content-center d-lg-block flex-column gap-4">
              ...
              <div class="d-flex align-items-center justify-content-start gap-3 mt-lg-2">
                <button className='w-auto btn btn-primary rounded-5'>Get Started</button>
                <div class="d-flex gap-1 pt-3"><FaRegCirclePlay className='fs-4 fw-medium' /><p className=''>Play Video</p></div>
              </div>
            </div>
            <div class="right-home col-12 col-lg-6 mb-5 mt-5">
