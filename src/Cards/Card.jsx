    ...
    return (
        <div className='container my-5'>
            ...
            <div class="row my-5 gap-3">
                <div class="px-4 py-4 col-lg col-md d-flex flex-column align-items-start justify-content-center gap-3 rounded-3"style={{backgroundColor:"#fff3e2"}}>
                ...
                <div class="px-4 py-4 col-lg col-md d-flex flex-column gap-3 align-items-start justify-content-center rounded-3" style={{backgroundColor:"#deedfd"}}>
                ...
                <div class="px-4 py-4 col-lg col-md d-flex flex-column align-items-start justify-content-center gap-3 rounded-3" style={{backgroundColor:"#d5f1e4"}}>
                ...
                <div class="px-4 py-4 col-lg col-md d-flex flex-column align-items-start justify-content-center gap-3 rounded-3"style={{backgroundColor:"#fdeded"}}>
